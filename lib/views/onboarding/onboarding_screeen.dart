    ...
    return Scaffold(
      body: OnboardingPagePresenter(pages: [
        ...
        OnboardingPageModel(
          ...
          imageUrl: 'assets/pngegg (3).png',
          bgColor: Color.fromARGB(255, 142, 251, 227),
        ),
        OnboardingPageModel(
          ...
          imageUrl:
              'assets/portrait-young-beautiful-sportive-girl-white-background-removebg-preview.png',
          bgColor: const Color.fromARGB(255, 235, 193, 129),
        ),
        // OnboardingPageModel(
        //   title: 'Follow creators',
        //   description: 'Follow your favourite creators to stay in the loop.',
        //   imageUrl: 'assets/pngegg (2).png',
        //   bgColor: Color.fromARGB(255, 182, 88, 119),
        // ),
      ]),
    );
  }
